...
- [Semantic Pattern Guide](SEMANTIC_PATTERN_GUIDE.md) - Writing semantic patterns
- [New Features](NEW_FEATURES.md) - Feature development guide
...
| Layer 2 Support | [Quick Wins](QUICK_WINS.md#2-layer-2-chain-support) |
| Risk Scoring | [Quick Wins](QUICK_WINS.md#3-risk-scoring-system) |
| CI/CD Setup | [Quick Wins](QUICK_WINS.md#4-gitlabbitbucket-ci-integration) |
| Template Registry | [Ecosystem](ECOSYSTEM.md#1-template-registry) |
| Plugin System | [Ecosystem](ECOSYSTEM.md#3-plugin-system) |
| GitHub Action | [GitHub Action](GITHUB_ACTION.md) |
| Zero-Day Updates | [Fetch Zero-Day](FETCH_ZERODAY.md) |
